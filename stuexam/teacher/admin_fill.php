...
<div class="container" style="margin-left:23%" id="right">
	...
	echo "<ul>";
	echo "<li><a href=\"admin_fill.php?page=1&search=$search\">First</a></li>";
	if($page==1)
		echo "<li class=\"disabled\"><a href=\"\">Previous</a></li>";
	else
		echo "<li><a href=\"admin_fill.php?page=$prepage&search=$search\">Previous</a></li>";
	for($i=$startpage;$i<=$endpage;$i++)
	{
		if($i==$page)
			echo "<li class=\"active\"><a href=\"admin_fill.php?page=$i&search=$search\">$i</a></li>";
		else
	  		echo "<li><a href=\"admin_fill.php?page=$i&search=$search\">$i</a></li>";
	}
	if($page==$lastpage)
		echo "<li class=\"disabled\"><a href=\"\">Next</a></li>";
	else
		echo "<li><a href=\"admin_fill.php?page=$nextpage&search=$search\">Next</a></li>";
	echo "<li><a href=\"admin_fill.php?page=$lastpage&search=$search\">Last</a></li>";
	echo "</ul>";
	echo "</div>";
	?>
</div>
