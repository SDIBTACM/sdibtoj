...
<hr>
<center>
  <font size="+3"><?=$OJ_NAME?> Online Judge FAQ<a href="./faqs.cn.php">中文版说明</a></font>
</center>
<hr>
...
Here is a sample solution for problem 1003 using C++:<br>
<pre><font color="blue">
#include &lt;iostream&gt;
using namespace std;
int main(){
...
Here is a sample solution for problem 1003 using PASCAL:<br>
<pre><font color="blue">
