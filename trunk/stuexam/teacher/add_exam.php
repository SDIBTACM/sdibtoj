...
<div class="container" style="margin-left:23%" id="right">
	...
	考试开始时间:<p>
	<input type="text" name="syear"   value="<?=date('Y')?>" style="width:40px" />年-
	<input type="text" name="smonth"  value="<?=date('m')?>" style="width:40px" />月-
	<input type="text" name="sday"    value="<?=date('d')?>" style="width:40px" />日-
	<input type="text" name="shour"   value="<?=date('H')?>" style="width:40px" />时-
	<input type="text" name="sminute" value="00" style="width:40px" />分</p>
	考试结束时间:<p>
	<input type="text" name="eyear"   value="<?=date('Y')?>" style="width:40px" />年-
	<input type="text" name="emonth"  value="<?=date('m')?>" style="width:40px" style="width:40px" />月-
    <input type="text" name="eday"    value="<?=date('d')+(date('H')+2>23?1:0)?>" style="width:40px" />日-
    <input type="text" name="ehour"   value="<?=(date('H')+2)%24?>" style="width:40px" />时-
